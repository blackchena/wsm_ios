...
- (void)shouldRemovePlaceholderStyle:(BOOL) isRemove {
    if (isRemove) {
        _backgroundColors[@(FSCalendarCellStatePlaceholder)] = _backgroundColors[@(FSCalendarCellStateNormal)];
        _titleColors[@(FSCalendarCellStatePlaceholder)] = _titleColors[@(FSCalendarCellStateNormal)];
        _subtitleColors[@(FSCalendarCellStatePlaceholder)] = _subtitleColors[@(FSCalendarCellStateNormal)];
        _borderColors[@(FSCalendarCellStatePlaceholder)] = _borderColors[@(FSCalendarCellStateNormal)];
    }
}
